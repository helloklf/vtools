...
# 替换文件，用法如：
# magisk_replace_file "./custom/switchs/resources/com.android.systemui" "/system/media/theme/default/com.android.systemui"
...
# 判断文件是否与模块中某个文件相同，用法
# magisk_file_equals "./custom/switchs/resources/com.android.systemui" "/system/media/theme/default/com.android.systemui"
