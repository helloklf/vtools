...
if [ "$action" = "balance" ]; then
	...
	echo 94000 > /sys/devices/system/cpu/cpu0/cpufreq/interactive/hispeed_freq
	echo 96000 > /sys/devices/system/cpu/cpu2/cpufreq/interactive/hispeed_freq
...
if [ "$action" = "fast" ]; then
	...
	echo 2500000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq
	echo 2500000 > /sys/devices/system/cpu/cpu2/cpufreq/scaling_min_freq
	echo 2500000 > /sys/devices/system/cpu/cpu2/cpufreq/scaling_max_freq
