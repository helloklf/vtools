...
if [ "$action" = "powersave" ]; then
	...
	echo "0:1635000 1:1635000 2:1635000 3:1635000 4:1635000 5:1635000 6:1635000 7:1635000" > /sys/module/msm_performance/parameters/cpu_max_freq
	echo 100000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_min_freq
	echo 1635000 > /sys/devices/system/cpu/cpu0/cpufreq/scaling_max_freq
