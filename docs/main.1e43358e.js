...
var staticRenderFns = [
  ...
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "function-desc" }, [
      _c("span", [_vm._v("不再使用SWAP")]),
      _vm._v(
        " 如果SWAP正在被使用，可能无法立刻关闭。建议在Swap设置里关闭Swap的“开机自启”选项，重启手机，再进入Swap设置页面点击“删除”按钮。\n    "
      )
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "function-desc" }, [
      _c("span", [_vm._v("如何还原CPU设置")]),
      _vm._v(
        " 关闭CPU控制里的“开机后应用”选项，禁用“Scene - 场景模式”辅助服务，取消首页的电源模式选择，重启手机。或者直接卸载应用。\n    "
      )
    ])
  }
]
